...
public class RepairBWActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener,View.OnClickListener {
    ...
    private void makeColors(final int Time) {
        ...
        thread = new Thread(new Runnable() {
            public void run() {
                ...
                Intent intent2 = new Intent(RepairBWActivity.this,BeginActivity.class);
                intent2.putExtra("FromRepair","1");
                intent2.putExtra("Assistant",chkAssistant.isChecked());
                RepairBWActivity.this.startActivity(intent2);
                finish();
            }
        });
        thread.start();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_repair_b_w);
        ...
        stxtInstr = "1.- Before start repairing please ensure to put screen brightness at full.\n" +
                ...
                "5.- The screen will change between black and white colors, the device must not be used in this process.\n\n" +
        ...
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this,
                R.array.minuteshours, R.layout.spinner_bwitem);
