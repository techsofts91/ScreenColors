...
public class RepairGradient extends AppCompatActivity implements AdapterView.OnItemSelectedListener,View.OnClickListener {
    ...
    public void gradientBackground(final View view){
    ...
    private void makeColors(final int Time) {
        ...
        thread = new Thread(new Runnable() {
            public void run() {
                ...
                Intent intent2 = new Intent(RepairGradient.this,BeginActivity.class);
                intent2.putExtra("FromRepair","1");
                intent2.putExtra("Assistant",chkAssistant.isChecked());
                RepairGradient.this.startActivity(intent2);
                finish();
            }
        });
        thread.start();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_repair_gradient);
